          ...
          <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
              <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo get_status_class($user) ?> mr-3">
                                    <span class="rounded-circle profile-image d-block "
                                          style="background-image:url('<?php echo $user['image'] ?: "uploads/avatars/laravel.png" ?>'); background-size: cover;"></span>
                                </span>
                  ...
                  <a href="profile.php?id=<?php echo $user['id'] ?>"
                    ...
                    <?php if (is_can_edit($user['id'])): ?>
                      <div class="dropdown-menu">
                        ...
                        <a href="delete.php?id=<?php echo $user['id'] ?>" class="dropdown-item"
