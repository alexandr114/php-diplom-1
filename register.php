          ...
          <div class="row">
            ...
            <div class="col-xl-6 ml-auto mr-auto">
              <div class="card p-4 rounded-plus bg-faded">
                ...
                <form id="js-login" novalidate="" action="handlers/register.php" method="post">
                  <div class="form-group">
                    <label class="form-label" for="emailverify">Email</label>
                    <input name="email" type="email" id="emailverify" class="form-control" placeholder="Эл. адрес"
                           required>
